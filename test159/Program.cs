...

{
    class Test
    {
        static void Main(string[] args)
        {
            ...
            Program.Data.Message MyMessage = new Program.Data.Message("Hello I'am Here, From Message Class");
            ...
            es.Parser(MyMessage, EventStore.GetAllClasses("ServerGame.Program.Event"));
        }
    }
}
